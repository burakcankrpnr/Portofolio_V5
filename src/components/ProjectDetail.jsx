  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/burakcankrpnr',
      };
    ...
    return (
      <div className="min-h-screen bg-[#030014] flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          ...
          <h2 className="text-xl md:text-3xl font-bold text-white">Proje Yükleniyor...</h2>
        </div>
      </div>
    );
  }
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                >
                  ...
                  <span className="relative font-medium">Demo</span>
                </a>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                {project.TechStack.length > 0 ? (
                  ...
                  <p className="text-sm md:text-base text-gray-400 opacity-50">Hiçbir teknoloji eklenmedi.</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                ...
                {project.Features.length > 0 ? (
                  ...
                  <p className="text-gray-400 opacity-50">Hiçbir özellik eklenmedi.</p>
                )}
              </div>
            </div>
          </div>
