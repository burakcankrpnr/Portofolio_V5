...
const socialLinks = [
  ...
  },
  {
    name: "Email",
    displayName: "E-posta",
    subText: "burikcankorpinar7@gmail.com",
    icon: Mail,
    url: "mailto:burikcankorpinar7@gmail.com",
    color: "#EA4335",
...
const SocialLinks = () => {
  ...
  // Destructure with Email replacing the YouTube spot
  const [instagram, email, github, tiktok] = otherLinks;
